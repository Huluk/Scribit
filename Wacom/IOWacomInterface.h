...
enum
{
	...
	Wacom_Failure	= 32767, //	dsSysErr,	//	general failure result
	Wacom_CouldNotConnect =	-23, // openErr,		//	Tablet Driver is not running
	Wacom_Unimplemented	  =	-4   // unimpErr		//	Routine is not yet implemented
};
